...
class RedFilterNode(Node):
    def __init__(self):
        super().__init__('red_filter')
        
        # Define color conversion constants (optional)
        self.BGR2RED = (0, 0, 1)  # Set only red channel to 1
        ...
        self.subscription = self.create_subscription(
            ...
            10)
        self.publisher_ = self.create_publisher(Image, 'red_filtered_image', 10)
        self.br = CvBridge()
    ...
    def listener_callback(self, msg):
        ...
        cv_image[:, :, 1] = 0  # Set green channel to 0
